            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-16">
                <div class="space-y-5">
                    ...
                    <div class="flex space-x-3.5 pt-2">
                        <a href="https://wa.me/919313948854" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-slate-900 hover:bg-emerald-500 text-slate-400 hover:text-white flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 shadow-md border border-slate-800/80 text-base" aria-label="WhatsApp Corporate Desk"><i class="fab fa-whatsapp"></i></a>
                        <a href="#" class="w-10 h-10 rounded-xl bg-slate-900 hover:bg-gradient-to-tr hover:from-amber-500 hover:via-pink-500 hover:to-purple-600 text-slate-400 hover:text-white flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 shadow-md border border-slate-800/80 text-base" aria-label="Instagram Profile"><i class="fab fa-instagram"></i></a>
                        <a href="#" class="w-10 h-10 rounded-xl bg-slate-900 hover:bg-blue-600 text-slate-400 hover:text-white flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 shadow-md border border-slate-800/80 text-base" aria-label="Facebook Page"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <ul class="space-y-3.5 text-sm md:text-base font-semibold">
                        <li><a href="#home" class="group flex items-center text-slate-400 hover:text-white transition-colors duration-300"><i class="fas fa-chevron-right text-[10px] mr-0 opacity-0 group-hover:mr-2.5 group-hover:opacity-100 transition-all text-brand-pink"></i>Home Landing</a></li>
                        <li><a href="#features" class="group flex items-center text-slate-400 hover:text-white transition-colors duration-300"><i class="fas fa-chevron-right text-[10px] mr-0 opacity-0 group-hover:mr-2.5 group-hover:opacity-100 transition-all text-brand-pink"></i>Core Features</a></li>
                        <li><a href="#products" class="group flex items-center text-slate-400 hover:text-white transition-colors duration-300"><i class="fas fa-chevron-right text-[10px] mr-0 opacity-0 group-hover:mr-2.5 group-hover:opacity-100 transition-all text-brand-pink"></i>Product Matrix</a></li>
                        <li><a href="#about" class="group flex items-center text-slate-400 hover:text-white transition-colors duration-300"><i class="fas fa-chevron-right text-[10px] mr-0 opacity-0 group-hover:mr-2.5 group-hover:opacity-100 transition-all text-brand-pink"></i>Corporate Ethos</a></li>
                    </ul>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <ul class="space-y-3.5 text-sm md:text-base font-semibold">
                        <li><a href="#products" class="group flex items-center text-slate-400 hover:text-white transition-colors duration-300"><i class="fas fa-cube text-xs mr-2.5 text-slate-700 group-hover:text-brand-pink transition-colors"></i>Harroberry Day XL</a></li>
                        <li><a href="#products" class="group flex items-center text-slate-400 hover:text-white transition-colors duration-300"><i class="fas fa-moon text-xs mr-2.5 text-slate-700 group-hover:text-brand-purple transition-colors"></i>Heavy Overnight XXL</a></li>
                        <li><a href="#wholesale" class="group flex items-center text-slate-400 hover:text-white transition-colors duration-300"><i class="fas fa-handshake text-xs mr-2.5 text-slate-700 group-hover:text-violet-400 transition-colors"></i>B2B Bulk Packages</a></li>
                    </ul>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="bg-slate-900/40 border border-slate-900 rounded-2xl p-5 space-y-4 shadow-inner backdrop-blur-md">
                        ...
                        <div class="flex items-center space-x-3.5">
                            ...
                            <a href="tel:+919313948854" class="text-sm text-slate-300 hover:text-white transition-colors font-bold">+91 9313948854</a>
                        </div>
                        <div class="flex items-center space-x-3.5">
                            <i class="fas fa-envelope text-emerald-500 text-sm w-4"></i>
                            <a href="mailto:harroberry18@gmail.com" class="text-sm text-slate-300 hover:text-white transition-colors font-semibold overflow-hidden text-ellipsis whitespace-nowrap block max-w-[190px]">harroberry18@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
